...
function AdminDashboard({ onLogout }) {
  ...
  const loadData = async () => {
    ...
    const freshExpenses = getExpenses();
  ...
  const toggleMenuAvailability = (id, currentVal) => {
    updateMenuItem(id, { available: !currentVal });
    loadData();
  };

  const toggleMenuRecommendation = (id, currentVal) => {
    updateMenuItem(id, { recommended: !currentVal });
    loadData();
  };
